...
//
// Loaded into the service worker via importScripts() AFTER jszip.min.js and
// store.js — exposes self.AuditPackage. Requires global JSZip.
...
(function () {
  ...
  async function build(opts) {
    ...
    const [frames, timeline, steps, narration] = await Promise.all([
  ...
  self.AuditPackage = { build, stamp, clock };
})();
